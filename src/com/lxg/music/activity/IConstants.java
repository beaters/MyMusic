...
public interface IConstants {
	...
	public static final String BROADCAST_NAME = "com.lxg.music.broadcast";
	public static final String SERVICE_NAME = "com.lxg.music.service.MediaService";
	public static final String BROADCAST_QUERY_COMPLETE_NAME = "com.lxg.music.querycomplete.broadcast";
	public static final String BROADCAST_CHANGEBG = "com.lxg.music.changebg";
	public static final String BROADCAST_SHAKE = "com.lxg.music.shake";
	
	//是否开启了振动模式
	public static final String SHAKE_ON_OFF = "SHAKE_ON_OFF";


	//SharedPreferences的静态名
	public static final String SP_NAME = "com.lxg.music_preference";
	...
	public static final int BLURRADIUS=8;
