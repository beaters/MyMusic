...
import com.lxg.music.fragment.MainFragment;
import com.lxg.music.fragment.MenuFragment;
import com.lxg.music.slidemenu.SlidingMenu;
import com.lxg.music.utils.MusicUtils;
import com.lxg.music.utils.SplashScreen;
...
public class MainContentActivity extends FragmentActivity implements IConstants {
	...
	protected void onCreate(Bundle arg0) {
		...
		registerReceiver(mAlarmReceiver, filter);// 定时退出程序，设定广播消息接收器

		setContentView(R.layout.frame_main);
		mSplashScreen = new SplashScreen(this);
		mSplashScreen.show(SplashScreen.SLIDE_LEFT);
		// set the Above View
	...
	public void showSleepDialog() {
		...
		if (MusicApp.mIsSleepClockSetting) {
			cancleSleepClock();
			Toast.makeText(getApplicationContext(), "睡眠模式已经取消！",
					Toast.LENGTH_SHORT).show();
			return;
		}
	...
	private void setSleepClock(String timeS) {
		...
		Toast.makeText(getApplicationContext(), "软件将在"+timeS+"分钟后退出", Toast.LENGTH_SHORT)
				.show();
	}
