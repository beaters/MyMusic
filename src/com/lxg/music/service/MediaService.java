...
import com.lxg.music.shake.ShakeDetector;
import com.lxg.music.shake.ShakeDetector.OnShakeListener;
...
public class MediaService extends Service implements IConstants, OnShakeListener {
	...
	private static final String PAUSE_BROADCAST_NAME = "com.lxg.music.pause.broadcast";
	private static final String NEXT_BROADCAST_NAME = "com.lxg.music.next.broadcast";
	private static final String PRE_BROADCAST_NAME = "com.lxg.music.pre.broadcast";
